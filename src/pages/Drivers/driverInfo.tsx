...
import { onUpdateDriver } from '../../redux/slices/drivers';
...
export const DriverInfo = ({ driver }) => {
  ...
  const onChangeStatus = () => {
    ...
    dispatch(onUpdateDriver(payload));
  };
  return (
    <>
      <div className="grid w-full grid-cols-2 gap-y-4 gap-x-12">
        ...
        <div className="flex flex-col text-sm">
          <div>Email</div>
          <div className="text flex justify-between border-b border-black-primary border-opacity-20 py-2 font-semibold">
            <div className="text-black-primary">{driver?.email}</div>
          </div>
        </div>
        <div className="flex flex-col text-sm">
          <div>Phone</div>
          <div className="text flex justify-between border-b border-black-primary border-opacity-20 py-2 font-semibold">
            <div className="text-black-primary">{driver?.phone}</div>
          </div>
        </div>
        <div className="flex flex-col text-sm">
          <div>Age</div>
